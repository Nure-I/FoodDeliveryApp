...
const Home = ({ navigation }) => {
	...
	function onSelectCatagory(catagory) {
		// filter restaurant
		let restaurantList = restaurantData.filter((a) =>
			a.categories.includes(catagory.id)
		);
